...
if (hasFish || hasPizza) && hasVegan {
    ...
    print("Sorry, we'll have to think of somewhere else to go.")
}
...
//I intepret this as "(not raining) or if it's (82 degress or warmer and sunny out)", which are weird criteria but ok

if isNiceWeather {
    print("I'm going for a walk!")
} else {
    print("Nope, not going for a walk.")
}
