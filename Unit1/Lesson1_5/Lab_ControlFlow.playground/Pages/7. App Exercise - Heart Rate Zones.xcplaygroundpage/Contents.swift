...
case 141...160: print("ou are in the Moderate zone. Activity in this zone helps improve aerobic fitness.")
...
case ...99: print("Pick up the pace!")
default: print("Slow down!")
