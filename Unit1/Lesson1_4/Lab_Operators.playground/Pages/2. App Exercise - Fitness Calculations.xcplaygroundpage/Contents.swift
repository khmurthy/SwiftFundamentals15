...
print(averageHRD)
print("It does not differ from my previous average because I chose numbers that, when summed, are divisible by three. If I had chosen a different set of numbers that result in a non-whole average, the int version of the average would be rounded down to the nearest integer.")
