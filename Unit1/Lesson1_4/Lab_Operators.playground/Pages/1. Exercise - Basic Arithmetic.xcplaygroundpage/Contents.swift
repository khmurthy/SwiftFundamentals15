...
print("I would expect int 10 / 3 to equal 3")
...
print("\(even) % 2 = \(even % 2)")
print("\(odd) % 2 = \(odd % 2)")
print("If the remainder is 1 when an int is divided by 2, the int must be odd. If the remainder is 0, the int must be even.")
/*:
