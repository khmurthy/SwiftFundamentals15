...
class Fighter: Spaceship {
    ...
    func fire(displayRFP: Bool = false) {
...
//"falcon" does not refer to anything in this file. It's an instance of Spaceship, but it was defined in another file so that is where it can be accessed.
...
destroyer.fire(displayRFP: true)
destroyer.fire(displayRFP: true)
destroyer.fire(displayRFP: true)
destroyer.fire(displayRFP: true)
