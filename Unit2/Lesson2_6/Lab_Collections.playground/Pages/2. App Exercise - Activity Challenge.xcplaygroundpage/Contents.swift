 ...
 */
var walkingChallenges: [String] = ["Walk 3 miles a day", "Walk 10 miles a week"]
var runningChallenges: [String] = ["Run 3 miles a day", "Run 10 miles a week"]
...
if committedChallenges.isEmpty {
    print("You have not committed to any challenges. Please choose at least one challenge to commit to.")
