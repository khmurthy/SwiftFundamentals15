...
struct User {
    ...
    func displayUser() {
        print("Name: \(name), Age: \(age), Height: \(height) meters, Weight: \(weight) kilograms, Activity Level: \(activityLevel)")
    }
}

//:  Create a variable instance of `User` and call it your name. Use the memberwise initializer to pass in information about yourself. Then print out a description of your `User` instance using the instance's properties.
var kieran = User(name: "Kieran", age: 23, height: 1.75, weight: 90, activityLevel: 4)
kieran.displayUser()
/*:
