...
var rec = Rectangle(width: 3, height: 4)
print("Width: \(rec.area)")
/*:
...
print("Current height in inches: \(myHeight.heightInInches)")
print("Current height in centimeters: \(myHeight.heightInCentimeters)")

myHeight.heightInInches = 72
print("Height in inches updated to 72:")
print("Current height in inches: \(myHeight.heightInInches)")
print("Current height in centimeters: \(myHeight.heightInCentimeters)")
