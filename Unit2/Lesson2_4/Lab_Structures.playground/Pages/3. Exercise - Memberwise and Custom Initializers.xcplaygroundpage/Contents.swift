...
let somePlace = GPS(lat: 51.514004, lon: 0.125226)
displayGPS(somePlace)
...
func printBook(_ book: Book) {
    print("\(book.title) was written by \(book.author), is \(book.pages) long, and costs $\(book.price)")
}

var favoriteBook: Book = Book(title: "Words of Radiance", author: "Brandon Sanderson", pages: 1200, price: 12.99)
printBook(favoriteBook)
...
var dell = Laptop(yearPurchased: 2019)
var macBookPro = Laptop(yearPurchased: 2018)
/*:
...
var myHeight = Height(heightInInches: 69.5)
